      ...
      switch(secenek){
        ...
        case 3:
          ...
          del(root,sayi_1);
			...
			printf("\n\nYeni bir islem yapmak istiyor musunuz?(Y/N): "); // yeni bir ekleme durumun,  olusturulan agacin s�ralanmas� yada program�n sonland�r�lmas� icin kullan�c�ya secenek sunuldu.
				scanf("%s", &choose);
